    ...
    <div class="left-box col-md-6 rounded-5">
        <form action="registerInfo" method="post">
            <div class="input-group mb-3 form-group mt-4">
              <input type="text" class="form-control form-control-lg bg-light fs-6 rounded-pill" placeholder="Company Name" name="age" required="required">
				<input type="text" class="form-control form-control-lg bg-light fs-6 rounded-pill" placeholder="" name="age" required="required">		
            </div>
            <div class="input-group mb-3 form-group d-flex justify-content-center">
             ...
             <div class="input-group mb-3 form-group">
                <select class="form-select form-select-lg bg-light fs-6 rounded-pill" name="education" aria-label="Default select example">
                    <option selected disabled>Education</option>
                    <option value="1">Bachelors</option>
                    <option value="2">Doctoral</option>
                  </select>
            </div>
              <div class="input-group mb-3 form-group">
