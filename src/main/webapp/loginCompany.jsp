...
@media only screen and (max-width: 768px){
  ...
  <body style="background-image: url('https://i.imgur.com/as1eDDA.png'); width: 100%; height: 100vh; background-size: cover;" class="img-fluid">
    <header>
    ...
    <!-----------Right side----------->
        <div class="right-box col-md-6 rounded-5">
          <div class="row align-items-center">
            <div class="header-text mb-3">
              <h2 class="fw-bold">Login</h2>
              <p>Welcome</p>
            </div>
            <form action="UserLoginCompany" method="post">
            ...
            <div class="input-group mb-4 d-flex justify-content-between">
              ...
              <div class="forgot">
                  <small><a href="#" style="text-decoration: none; color: black" class="fw-bold">Forgot Password?</a></small>
              </div>
              </div>
             <div class="justify-content-center text-center text-danger">
			    <% 
            ...
            <div class="input-group mb-3">
              <button class="btn btn-1 btn-lg w-100 fs-6 fw-bold" type="submit">Login</button>
            </div>
            <div class="input-group mb-3">
              <button class="btn btn-lg btn-light w-100 fs-6"><img src="https://i.imgur.com/V98OyxD.png" style="width:20px" class="me-2"/><small>Sign in with Google</small></button>
            </div>
            </form>
            <div class="row">
              <small class="text-wrap text-center ms-3 fw-bold text-black"><a href="registerCompany.jsp" style="text-decoration: none; color: black;">Create an account</a></small>
            </div>
