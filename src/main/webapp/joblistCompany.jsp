    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="job-listing bg-white p-4 rounded-4 shadow-sm mb-3">
                ...
                <a href="showJobDetails?id=<c:out value='${work.id}' />" class="btn btn-1">View Applicants</a>
                <a href="deleteWork?id=<c:out value='${work.id}' />" class="btn btn-1">Remove Listing</a>
            </div>
            </c:if>
            </c:forEach>
        </div>
