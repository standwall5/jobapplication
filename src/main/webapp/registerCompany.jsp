        ...
        <div class="right-box col-md-6">
          <div class="row align-items-center">
            ...
            <div class="input-group mb-3 form-group">
              <input type="text" class="form-control form-control-lg bg-light me-2" placeholder="Company Name"
            ...
            <div class="row">
              <small class="text-wrap text-center ms-3 fw-bold"><a href="loginCompany.jsp" style="text-decoration: none; color: black;">Go to Login</a></small>
            </div>
